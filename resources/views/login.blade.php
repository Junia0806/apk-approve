    ...
    <div class="w-full max-w-md mx-auto mt-10 px-4 py-8">
        ...
        <div class="bg-white bg-opacity-60 rounded-lg shadow-lg p-8">
            <div class="mb-6 text-center">
                ...
                <p class="text-lg text-gray-800">Masukkan email dan password</p>
            </div>
            ...
            <form class="max-w-sm mx-auto" action="{{ route('login') }}" method="POST">
                ...
                <div class="flex mb-4">
                    <span
                        ...
                        <svg class="w-4 h-4 text-gray-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                            fill="currentColor" viewBox="0 0 20 20">
                            <path
                                d="M10 2a4 4 0 0 0-4 4v2H5a1 1 0 0 0-1 1v8a1 1 0 0 0 1 1h10a1 1 0 0 0 1-1V9a1 1 0 0 0-1-1h-1V6a4 4 0 0 0-4-4Zm-2 6V6a2 2 0 0 1 4 0v2H8Zm2 4a1 1 0 1 1 0 2 1 1 0 0 1 0-2Z" />
                        </svg>
                    </span>
                ...
                <!-- Button -->
                <button type="submit"
                    class="w-full text-white bg-blue-600 hover:bg-blue-700 focus:ring-2 focus:ring-blue-300 font-medium rounded-lg text-sm py-2.5 text-center block">
                    Login
                </button>
            </form>
