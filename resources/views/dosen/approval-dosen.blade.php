                              ...
                              <div class="p-6 text-center">
                                  ...
                                  <form action="/" method="POST" class="space-y-4">
                                      ...
                                      <div class="text-left mt-4">
                                          ...
                                          <select name="status_approval" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 mt-1" required>
