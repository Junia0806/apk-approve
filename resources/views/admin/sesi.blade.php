...
@section('content')
    <div class="container mx-auto p-6 mt-10 min-h-screen">
        ...
        <div class="overflow-x-auto">
            <form class="max-w-md mx-auto my-4" method="GET" action="{{ route('adminSesi') }}">
                ...
                <div class="relative">
                    ...
                    <input type="search" id="search" name="search"
                        ...
                        placeholder="Temukan sesi disini..." value="{{ request('search') }}" />
                    <button type="submit"
                                ...
                                <td colspan="5" class="p-6">
                                    <div class="flex flex-col items-center justify-center">
                                        ...
                                        <p class="text-center text-gray-600 text-lg font-semibold">
                                            Sesi "{{ request('search') }}" tidak ditemukan.
                                        </p>
                                    ...
                                    <div class="relative w-full max-w-full md:max-w-md h-full max-h-full md:h-auto">
                                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                            ...
                                            <div class="p-6 text-center">
                                                ...
                                                <form action="{{ route('adminSesi.update', $item->id_sesi) }}"
        ...
        @if (!request('search'))
            <div class="flex flex-col items-center my-6">
                <span class="text-sm text-gray-700 dark:text-gray-400">
                    Menampilkan <span class="font-semibold text-gray-900 dark:text-white">{{ $sesi->firstItem() }}</span>
                    sampai
