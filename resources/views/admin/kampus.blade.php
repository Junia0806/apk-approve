                            ...
                            <div class="relative w-full max-w-full md:max-w-md h-full max-h-full md:h-auto">
                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                    ...
                                    <div class="p-6 text-center">
                                        <h3 class="text-lg font-semibold text-gray-900">Edit Kampus</h3>
                                        <form action="/" method="POST" class="space-y-4">
                                            @csrf
                                            @method('PUT')
                                            <div class="text-left">
                                                <label for="nik" class="block text-sm font-medium text-gray-900">Kode
                                                    Kampus</label>
            ...
            <div class="relative p-4 w-full max-w-md max-h-full">
                <div class="relative bg-white rounded-lg shadow-lg">
                    ...
                    <form action="" method="POST" class="p-4">
                        ...
                        <div class="text-left mt-4">
                            <label for="nama_teknisi" class="block text-sm font-medium text-gray-900">Nama Kampus</label>
                            <input type="text" name="nama_dosen" id="nama_dosen"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 mt-1"
                                placeholder="Masukkan Nama Kampus" required>
                        </div>
    ...
    <script>
        ...
        function confirmDelete() {
            Swal.fire({
                ...
                text: "Anda tidak akan dapat mengembalikan Kampus ini!",
                icon: 'warning',
