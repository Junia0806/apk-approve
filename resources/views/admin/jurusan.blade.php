            ...
            <form class="max-w-md mx-auto my-4">
                ...
                <div class="relative">
                    ...
                    <input type="search" id="default-search"
                        ...
                        placeholder="Temukan Jurusan disini..." required />
                    <button type="submit"
            ...
            <div class="overflow-x-auto">
                <table class="w-full border-separate border-spacing-0 text-sm text-black">
                    <thead class="bg-gray-200 text-gray-800">
                        <tr>
                            <th class="p-2 text-center">Kode Jurusan</th>
                            <th class="p-2 text-center">Nama Jurusan</th>
                            ...
                            <div class="relative w-full max-w-full md:max-w-md h-full max-h-full md:h-auto">
                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                    ...
                                    <div class="p-6 text-center">
                                        <h3 class="text-lg font-semibold text-gray-900">Edit Jurusan</h3>
                                        <form action="/" method="POST" class="space-y-4">
                                            ...
                                            <div class="text-left mt-4">
                                                <label for="nama_teknisi"
                                                    class="block text-sm font-medium text-gray-900">Nama Jurusan</label>
            ...
            <div class="relative p-4 w-full max-w-md max-h-full">
                <div class="relative bg-white rounded-lg shadow-lg">
                    <div class="flex items-center justify-between p-4 border-b border-gray-200">
                        <h3 class="text-lg font-semibold text-black">Tambah Jurusan</h3>
                        <button type="button"
                    ...
                    <form action="" method="POST" class="p-4">
                        ...
                        <div class="text-left mt-4">
                            <label for="nama_teknisi" class="block text-sm font-medium text-gray-900">Nama Jurusan</label>
                            <input type="text" name="nama_dosen" id="nama_dosen"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 mt-1"
                                placeholder="Masukkan Nama Jurusan" required>
                        </div>
    ...
    <script>
        ...
        function confirmDelete() {
            Swal.fire({
                ...
                text: "Anda tidak akan dapat mengembalikan Jurusan ini!",
                icon: 'warning',
